...
@Slf4j
public class AlphanumericNormalizedTrainingParameter {
    ...
    //public static final double[][] testInputs = createNormalizedData(pickRandom(CharData.inputs));
    //public static final double[][] testTargets = createNormalizedData(pickRandom(CharData.targets));
