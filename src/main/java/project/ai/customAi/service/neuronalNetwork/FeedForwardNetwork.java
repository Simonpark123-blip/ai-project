...
import project.ai.customAi.pojo.neuronalNetwork.TrainingParameter;
...
public class FeedForwardNetwork {
    ...
    public FeedForwardNetwork(int inputCount, int hiddenLayerNeurons, int outputLayerNeurons) {
